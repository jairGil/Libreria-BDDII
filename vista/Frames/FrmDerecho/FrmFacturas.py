...
class FrmFacturas(QWidget):
    def __init__(self):
        ...
        self.lbl_id_buscar = QLabel(self)
        ...
        self.lbl_separador = QLabel("-" * 50, self.frm_detalles)
    ...
    def setupUi(self):
        ...
        self.layout_principal.addWidget(self.txt_id, 0, 2, 1, 2)
        self.layout_principal.addWidget(self.btn_buscar, 0, 4)
        self.layout_principal.addWidget(self.frm_factura, 1, 0, 1, 5)
        self.layout_principal.addWidget(self.btn_genera_pdf, 2, 4)
        self.layout_principal.addItem(spacerItem, 0, 5)
        self.layout_principal.addItem(spacerItem1, 0, 0)
        ...
        """
        self.label_12 = QLabel(self.frm_detalles)
        self.layout_detalles.addWidget(self.label_12, 3, 1, 1, 1)
        self.label_13 = QLabel(self.frm_detalles)
        self.layout_detalles.addWidget(self.label_13, 3, 2, 1, 1)
        self.label_11 = QLabel(self.frm_detalles)
        self.layout_detalles.addWidget(self.label_11, 4, 4, 1, 1)
        self.label_15 = QLabel(self.frm_detalles)
        self.layout_detalles.addWidget(self.label_15, 3, 4, 1, 1)
        self.label_14 = QLabel(self.frm_detalles)
        self.layout_detalles.addWidget(self.label_14, 3, 3, 1, 1)
        self.label_10 = QLabel(self.frm_detalles)
        self.layout_detalles.addWidget(self.label_10, 4, 3, 1, 1)
